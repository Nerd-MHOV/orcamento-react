...
var GetBudgetControlle_1 = require("./controllers/Budget/GetBudgetControlle");
var SaveBudgetController_1 = require("./controllers/Budget/SaveBudgetController");
...
var ActiveRequirementController_1 = require("./controllers/Requirement/ActiveRequirementController");
var DeleteRequirementController_1 = require("./controllers/Requirement/DeleteRequirementController");
var FindRequirementsController_1 = require("./controllers/Requirement/FindRequirementsController");
var GetaRequiremetController_1 = require("./controllers/Requirement/GetaRequiremetController");
var NewRequirementController_1 = require("./controllers/Requirement/NewRequirementController");
var PriceRequirementController_1 = require("./controllers/Requirement/PriceRequirementController");
...
var CreateTariffWithTextController_1 = require("./controllers/Tariff/CreateTariffWithTextController");
var DeleteTariffController_1 = require("./controllers/Tariff/DeleteTariffController");
var FindTariffController_1 = require("./controllers/Tariff/FindTariffController");
var GetaTariffController_1 = require("./controllers/Tariff/GetaTariffController");
...
var getaTariff = new GetaTariffController_1.GetaTariffController();
var createTariff = new CreateTariffController_1.CreateTariffController();
var createTariffText = new CreateTariffWithTextController_1.CreateTariffWithTextController();
var deleteTariff = new DeleteTariffController_1.DeleteTariffController();
...
var newRequirement = new NewRequirementController_1.NewRequirementController();
var findRequirements = new FindRequirementsController_1.FindRequirementsController();
var findaRequirement = new GetaRequiremetController_1.GetaRequirementController();
var deleteRequirement = new DeleteRequirementController_1.DeleteRequirementController();
var findAllHousingUnits = new FindAllHousingUnits_1.FindAllHousingUnits();
var activeRequirement = new ActiveRequirementController_1.ActiveRequirementController();
var priceRequirement = new PriceRequirementController_1.PriceRequirementController();
...
var saveBudget = new SaveBudgetController_1.SaveBudgetController();
var getBudget = new GetBudgetControlle_1.GetBudgetController();
...
routes["delete"]("/user/:id", isAdmin_1.isAdmin, deleteUser.handle);
routes.get("/user", isAdmin_1.isAdmin, findUser.handle);
...
routes.post("/tariff/delete", isAdmin_1.isAdmin, deleteTariff.handle);
...
routes.put("/requirement/active/:name", isAdmin_1.isAdmin, activeRequirement.handle);
routes.put("/requirement/price", isAdmin_1.isAdmin, priceRequirement.handle);
