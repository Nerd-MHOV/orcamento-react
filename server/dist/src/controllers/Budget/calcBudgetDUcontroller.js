...
exports.CalcBudgetDUController = void 0;
var date_fns_1 = require("date-fns");
var duAdultBudget_1 = require("./functions/duAdultBudget");
var duChildBudget_1 = require("./functions/duChildBudget");
var petBudget_1 = require("./functions/petBudget");
var requirementBudget_1 = require("./functions/requirementBudget");
var CalcBudgetDUController = /** @class */ (function () {
    function CalcBudgetDUController() {
    }
    CalcBudgetDUController.prototype.handle = function (request, response) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, duAdultBudget_1.duAdultBudget)(arrForm, arrChild, initDate)];
                    case 1:
                        //adult
                        adultRows = _b.sent();
                        return [4 /*yield*/, (0, duChildBudget_1.duChildBudget)(arrChild, arrForm, initDate)];
                    case 2:
                        //child
                        childRows = _b.sent();
    ...
    return CalcBudgetDUController;
}());
exports.CalcBudgetDUController = CalcBudgetDUController;
//# sourceMappingURL=calcBudgetDUcontroller.js.map